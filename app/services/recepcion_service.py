...
class RecepcionService:
    ...
    def confirmar_recepcion(recepcion_id: int, observaciones: str = None,
        ...
        if recepcion.estado == 'CONFIRMADA':
            ...
            _job_rec = SiesaJob.encolar(
                ...
                payload={
                    ...
                    'num_docto_referencia': _limpiar_remision(recepcion.num_remision_prov) or _limpiar_remision(recepcion.codigo),
                },
                referencia_tipo='RecepcionMercancia',
                referencia_id=recepcion.id,
            )
        ...
        try:
            ...
            if recepcion.co_oc_siesa and rows_oc:
                rows_oc = [r for r in rows_oc if r.get('f420_id_co', '').strip() == recepcion.co_oc_siesa]
            if not rows_oc:
        ...
        job_dlq = SiesaJob.encolar(
            ...
            payload={
                ...
                'num_docto_referencia': remision or _limpiar_remision(recepcion.codigo),
                'cond_pago': recepcion.cond_pago_siesa or '',
            },
            referencia_tipo='RecepcionMercancia',
            referencia_id=recepcion.id,
