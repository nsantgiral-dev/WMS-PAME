  ...
  el.innerHTML = `
    ...
    <div style="background:#0B1117;border:1px solid #1e3a5f;border-radius:12px;padding:10px 14px;margin-bottom:16px;display:flex;align-items:center;gap:10px;">
      ...
      <div>
        ...
        <div style="font-size:14px;font-weight:700;color:#fff;">${esc(p.vendedor_nombre || '—')}</div>
        ${p.vendedor_telefono ? `<a href="tel:${esc(p.vendedor_telefono)}" style="color:#4ade80;font-size:13px;text-decoration:none;">📞 ${esc(p.vendedor_telefono)}</a>` : ''}
      </div>
    </div>
    ` : ''}
      ...
      <div id="cond-parcial-detalle" style="margin-bottom:14px;display:none;">
        ...
        <div id="cond-motivo-descuento-wrap" style="margin-top:12px;display:none;">
          ...
          <div style="margin-top:10px;padding:12px;background:#451a03;border:1px solid #d97706;border-radius:10px;">
            ...
            <div style="font-size:14px;color:#fff;font-weight:700;">${esc(p.vendedor_nombre || '—')}</div>
            ${p.vendedor_telefono ? `<a href="tel:${esc(p.vendedor_telefono)}" style="display:inline-block;margin-top:4px;color:#4ade80;font-size:14px;text-decoration:none;">📞 ${esc(p.vendedor_telefono)}</a>` : ''}
          </div>
          ` : ''}
        </div>
      </div>
