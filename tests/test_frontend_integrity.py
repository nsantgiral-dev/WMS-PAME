...
DEUDA_SIN_UI = {
    ...
    # tienen pantalla. Queda la serie diaria de UNA métrica: la portada muestra
    # 8 semanas por indicador, y el zoom por día es la pantalla de tendencias.
    '/api/analitica/serie':
...
class TestModoClaroCubreFondosOscuros:
    ...
    ALLOWLIST = {
        ...
        # Dos de la misma paleta del conductor, que el merge del 2026-09-18
        # trajo sin declarar: #f0fdf4 ya ES claro (verde muy pálido de la
